	...
	EditArea.prototype.init= function(){
		...
		if(syntax_selec= _$("syntax_selection"))
		{
			...
			for(var i=0; i<t.syntax_list.length; i++) {
				...
				option.innerHTML= typeof( dispSyntax ) == 'undefined' ? syntax.mb_substring( 0, 1 ).toUpperCase() + syntax.mb_substring( 1 ) : dispSyntax;//t.get_translation("syntax_" + syntax, "word");
